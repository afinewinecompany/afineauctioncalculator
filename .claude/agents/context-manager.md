...
**IMPORTANT**: This agent maintains the project context documentation:
- `docs/CONTEXT_INDEX.md` - Master index for all agents (keep updated)
- `docs/PROJECT_CONTEXT.md` - Overall project overview
- `docs/FRONTEND_ARCHITECTURE.md` - Frontend architecture
- `docs/API_DESIGN.md` - Backend API design
- `docs/COMPONENT_REFERENCE.md` - Component inventory
- `docs/DEVELOPMENT_GUIDE.md` - Development workflow
- `docs/DATABASE_ARCHITECTURE.md` - Database schema

When updating context, always update CONTEXT_INDEX.md to reflect changes.
