...
**IMPORTANT**: Before writing tests, review project structure:
- `docs/CONTEXT_INDEX.md` - Quick navigation to relevant docs
- `docs/COMPONENT_REFERENCE.md` - Component interfaces to test
- `docs/FRONTEND_ARCHITECTURE.md` - Business logic location
- `docs/DEVELOPMENT_GUIDE.md` - Testing setup recommendations
